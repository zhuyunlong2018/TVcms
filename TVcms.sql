/*
 ...
 Source Schema         : bianquan

 Target Server Type    : MySQL
 Target Server Version : 50553
 File Encoding         : 65001

 Date: 25/02/2019 17:32:56
*/
...
-- ----------------------------
-- Table structure for tv_about
-- ----------------------------
DROP TABLE IF EXISTS `tv_about`;
CREATE TABLE `tv_about`  (
  `about_id` int(11) NOT NULL AUTO_INCREMENT,
  `about_content` text CHARACTER SET utf8 COLLATE utf8_general_ci COMMENT 'about内容',
...
CREATE TABLE `tv_admin`  (
  ...
  `admin_name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '管理员名称',
  `create_time` timestamp NULL DEFAULT NULL,
  `update_time` timestamp NULL DEFAULT NULL,
  `delete_time` timestamp NULL DEFAULT NULL,
...
-- Records of tv_admin
-- ----------------------------
INSERT INTO `tv_admin` VALUES (1, '超级管理员', NULL, NULL, NULL, 1, 1);
INSERT INTO `tv_admin` VALUES (4, '测试管理员', NULL, NULL, NULL, 2, 0);

-- ----------------------------
-- Table structure for tv_admin_role
-- ----------------------------
...
-- ----------------------------
-- Records of tv_admin_role
-- ----------------------------
INSERT INTO `tv_admin_role` VALUES (6, 1, 1, NULL, NULL, NULL);
INSERT INTO `tv_admin_role` VALUES (10, 4, 6, NULL, NULL, NULL);

-- ----------------------------
-- Table structure for tv_api
-- ----------------------------
DROP TABLE IF EXISTS `tv_api`;
CREATE TABLE `tv_api`  (
  `api_id` int(6) NOT NULL AUTO_INCREMENT COMMENT 'api的ID',
  `api_name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT 'api描述',
  `api_path` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT 'api路劲',
  `create_time` timestamp NULL DEFAULT NULL,
  `update_time` timestamp NULL DEFAULT NULL,
  `delete_time` timestamp NULL DEFAULT NULL,
...
CREATE TABLE `tv_article`  (
  ...
  `a_title` varchar(30) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '文章标题',
  `a_content` text CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '内容',
  `create_time` timestamp NULL DEFAULT NULL COMMENT '时间',
  `a_img` text CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '背景图',
...
-- ----------------------------
INSERT INTO `tv_comment` VALUES (47, 16, NULL, 'dfdfa', 'fdfsdfasdfasdfsadfsa', NULL, 0, 0, 0, 0, NULL, NULL);
INSERT INTO `tv_comment` VALUES (48, 16, NULL, 'dfdfa', '大大大和佛菩萨的时间发的发的是发达', NULL, 0, 0, 0, 0, NULL, NULL);
INSERT INTO `tv_comment` VALUES (49, 16, NULL, '第二天', '大富豪发大水发的沙发斯蒂芬', '0000-00-00 00:00:00', 0, 48, 0, 48, '0000-00-00 00:00:00', NULL);
INSERT INTO `tv_comment` VALUES (50, 16, NULL, '法法', '大大发撒的发顺丰', '0000-00-00 00:00:00', 0, 47, 0, 47, '0000-00-00 00:00:00', NULL);
INSERT INTO `tv_comment` VALUES (51, 16, NULL, '大丰收', '打对方苏打水费发士大夫撒旦法撒旦法', '0000-00-00 00:00:00', 0, 50, 0, 47, '0000-00-00 00:00:00', NULL);
INSERT INTO `tv_comment` VALUES (52, 16, NULL, '发的法法', '国防生的高大发大发', '0000-00-00 00:00:00', 0, 48, 0, 48, '0000-00-00 00:00:00', NULL);
INSERT INTO `tv_comment` VALUES (53, 16, NULL, '123', '回复1。1', '0000-00-00 00:00:00', 0, 50, 0, 47, '0000-00-00 00:00:00', NULL);
INSERT INTO `tv_comment` VALUES (54, 16, NULL, '第一', '的发的发的发', '0000-00-00 00:00:00', 0, 0, 0, 0, '0000-00-00 00:00:00', NULL);
INSERT INTO `tv_comment` VALUES (55, 16, NULL, '第一', '的发的发的发1111111', '0000-00-00 00:00:00', 0, 47, 0, 47, '0000-00-00 00:00:00', NULL);
INSERT INTO `tv_comment` VALUES (56, 16, NULL, '111', '发打发打发', '0000-00-00 00:00:00', 0, 50, 0, 47, '0000-00-00 00:00:00', NULL);
INSERT INTO `tv_comment` VALUES (57, 16, NULL, '1', '1', '0000-00-00 00:00:00', 0, 48, 0, 48, '0000-00-00 00:00:00', NULL);
INSERT INTO `tv_comment` VALUES (58, 16, NULL, '2', '2', '0000-00-00 00:00:00', 0, 47, 0, 47, '0000-00-00 00:00:00', NULL);
INSERT INTO `tv_comment` VALUES (59, 16, NULL, '3', '3', '0000-00-00 00:00:00', 0, 51, 0, 47, '0000-00-00 00:00:00', NULL);
INSERT INTO `tv_comment` VALUES (60, 16, NULL, '4', '4', '0000-00-00 00:00:00', 0, 58, 0, 47, '0000-00-00 00:00:00', NULL);
INSERT INTO `tv_comment` VALUES (61, 0, 1, '边泉', 'dfadff', '0000-00-00 00:00:00', 0, 0, 0, 0, '0000-00-00 00:00:00', NULL);
INSERT INTO `tv_comment` VALUES (62, 0, 1, '边泉', 'fdadfaf', '0000-00-00 00:00:00', 0, 0, 0, 0, '0000-00-00 00:00:00', NULL);
INSERT INTO `tv_comment` VALUES (63, 0, 1, '边泉', 'dfadsfa', '0000-00-00 00:00:00', 0, 0, 0, 0, '0000-00-00 00:00:00', NULL);
INSERT INTO `tv_comment` VALUES (64, 0, 1, '边泉', 'dfafadfad', '0000-00-00 00:00:00', 0, 61, 0, 61, '0000-00-00 00:00:00', NULL);
INSERT INTO `tv_comment` VALUES (65, 0, 1, '边泉', 'fdsafadsfdsafd', '0000-00-00 00:00:00', 0, 62, 0, 62, '0000-00-00 00:00:00', NULL);
INSERT INTO `tv_comment` VALUES (66, 0, 1, '边泉', 'fdafdaf', '0000-00-00 00:00:00', 0, 0, 0, 0, '0000-00-00 00:00:00', NULL);
INSERT INTO `tv_comment` VALUES (67, 0, 1, '边泉', 'fdafdafdfafads', '0000-00-00 00:00:00', 0, 66, 0, 66, '0000-00-00 00:00:00', NULL);
INSERT INTO `tv_comment` VALUES (68, 0, 1, '边泉', 'fdfadsfa', '0000-00-00 00:00:00', 0, 61, 0, 61, '0000-00-00 00:00:00', NULL);
INSERT INTO `tv_comment` VALUES (69, 0, 1, '边泉', 'dffadfdaf', '0000-00-00 00:00:00', 0, 68, 0, 61, '0000-00-00 00:00:00', NULL);
INSERT INTO `tv_comment` VALUES (70, 0, 1, '边泉', 'fdaf', '0000-00-00 00:00:00', 0, 0, 0, 0, '0000-00-00 00:00:00', NULL);
INSERT INTO `tv_comment` VALUES (71, 0, 1, '边泉', 'fdaf', '0000-00-00 00:00:00', 0, 0, 0, 0, '0000-00-00 00:00:00', NULL);
INSERT INTO `tv_comment` VALUES (72, 0, 1, '边泉', 'fdaf', '0000-00-00 00:00:00', 0, 64, 0, 61, '0000-00-00 00:00:00', NULL);
INSERT INTO `tv_comment` VALUES (73, 0, 1, '边泉', 'fdasfad', '0000-00-00 00:00:00', 0, 0, 0, 0, '0000-00-00 00:00:00', NULL);
INSERT INTO `tv_comment` VALUES (74, 0, 1, '边泉', 'fdfadsfad', '0000-00-00 00:00:00', 0, 0, 0, 0, '0000-00-00 00:00:00', NULL);
INSERT INTO `tv_comment` VALUES (75, 0, 1, '边泉', 'fdfadfad', '0000-00-00 00:00:00', 0, 64, 0, 61, '0000-00-00 00:00:00', NULL);
INSERT INTO `tv_comment` VALUES (76, 0, 1, '边泉', 'dfa', '0000-00-00 00:00:00', 0, 64, 0, 61, '0000-00-00 00:00:00', NULL);
INSERT INTO `tv_comment` VALUES (77, 0, 1, '边泉', 'dfadf', '0000-00-00 00:00:00', 0, 61, 0, 61, '0000-00-00 00:00:00', NULL);
INSERT INTO `tv_comment` VALUES (78, 0, 1, '边泉', 'fdsafadsfa', '0000-00-00 00:00:00', 0, 70, 0, 70, '0000-00-00 00:00:00', NULL);
INSERT INTO `tv_comment` VALUES (79, 0, 1, '边泉', 'dfafaf', '0000-00-00 00:00:00', 0, 73, 0, 73, '0000-00-00 00:00:00', NULL);
INSERT INTO `tv_comment` VALUES (80, 16, 1, '边泉', '发放的沙发', '0000-00-00 00:00:00', 0, 0, 0, 0, '0000-00-00 00:00:00', NULL);
INSERT INTO `tv_comment` VALUES (81, 16, 1, '边泉', '打啊', '0000-00-00 00:00:00', 0, 0, 0, 0, '0000-00-00 00:00:00', NULL);
INSERT INTO `tv_comment` VALUES (82, 0, 1, '边泉', 'fadfa打发打发', '0000-00-00 00:00:00', 0, 0, 0, 0, '2019-02-11 15:29:58', NULL);
INSERT INTO `tv_comment` VALUES (83, 0, 1, '边泉', '发打发打发', '2019-02-11 15:31:13', 0, 0, 0, 0, '2019-02-11 15:31:13', NULL);
INSERT INTO `tv_comment` VALUES (84, 17, 0, '方方达', '大的事发后暗示法', '2019-02-18 21:32:50', 0, 0, 0, 0, '2019-02-18 21:32:50', NULL);
...
CREATE TABLE `tv_config`  (
  ...
  `key` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '配置名',
...
-- ----------------------------
INSERT INTO `tv_config` VALUES (1, 'user_register_status', '1', '2019-02-11 18:14:28', '0000-00-00 00:00:00', '0000-00-00 00:00:00');
INSERT INTO `tv_config` VALUES (2, 'blog_article_status', '1', '2019-02-11 18:14:47', '0000-00-00 00:00:00', '0000-00-00 00:00:00');
INSERT INTO `tv_config` VALUES (3, 'blog_comment_status', '1', '2019-02-11 18:14:57', '0000-00-00 00:00:00', '0000-00-00 00:00:00');

-- ----------------------------
-- Table structure for tv_images
-- ----------------------------
DROP TABLE IF EXISTS `tv_images`;
CREATE TABLE `tv_images`  (
  `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT,
  `image` varchar(500) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '图片名',
  `path` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '本地拼接路劲',
...
-- ----------------------------
-- Table structure for tv_images_source
-- ----------------------------
DROP TABLE IF EXISTS `tv_images_source`;
CREATE TABLE `tv_images_source`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `image_id` int(11) DEFAULT NULL COMMENT '图片id',
  `table_name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '关联表名',
...
-- ----------------------------
-- Table structure for tv_menu_api
-- ----------------------------
...
-- ----------------------------
-- Records of tv_menu_api
-- ----------------------------
INSERT INTO `tv_menu_api` VALUES (22, 5, 25, NULL, NULL, NULL);
INSERT INTO `tv_menu_api` VALUES (23, 5, 26, NULL, NULL, NULL);
INSERT INTO `tv_menu_api` VALUES (24, 5, 24, NULL, NULL, NULL);
INSERT INTO `tv_menu_api` VALUES (25, 5, 9, NULL, NULL, NULL);
INSERT INTO `tv_menu_api` VALUES (27, 8, 31, NULL, NULL, NULL);
INSERT INTO `tv_menu_api` VALUES (35, 7, 29, NULL, NULL, NULL);
INSERT INTO `tv_menu_api` VALUES (36, 7, 40, NULL, NULL, NULL);
INSERT INTO `tv_menu_api` VALUES (37, 7, 28, NULL, NULL, NULL);
INSERT INTO `tv_menu_api` VALUES (38, 6, 20, NULL, NULL, NULL);
INSERT INTO `tv_menu_api` VALUES (39, 6, 22, NULL, NULL, NULL);
INSERT INTO `tv_menu_api` VALUES (40, 6, 21, NULL, NULL, NULL);
INSERT INTO `tv_menu_api` VALUES (41, 5, 23, NULL, NULL, NULL);
INSERT INTO `tv_menu_api` VALUES (42, 5, 19, NULL, NULL, NULL);
INSERT INTO `tv_menu_api` VALUES (43, 6, 41, NULL, NULL, NULL);
INSERT INTO `tv_menu_api` VALUES (44, 6, 42, NULL, NULL, NULL);
INSERT INTO `tv_menu_api` VALUES (45, 7, 27, NULL, NULL, NULL);
INSERT INTO `tv_menu_api` VALUES (46, 8, 28, NULL, NULL, NULL);

-- ----------------------------
-- Table structure for tv_neighbors
-- ----------------------------
DROP TABLE IF EXISTS `tv_neighbors`;
CREATE TABLE `tv_neighbors`  (
  `nb_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT,
  `nb_name` text CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '友链标题',
  `nb_url` text CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '地址',
  `nb_icon` text CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '图标地址',
  `create_time` timestamp NULL DEFAULT NULL,
...
-- ----------------------------
-- Records of tv_neighbors
-- ----------------------------
INSERT INTO `tv_neighbors` VALUES (2, '我的GitHub', 'https://github.com/920200256', '123', '2018-04-14 00:00:00', 1, NULL, NULL, 1);
INSERT INTO `tv_neighbors` VALUES (3, '奔三路学习网', 'http://www.bslxx.com/', '123', '2018-04-14 00:00:00', 1, NULL, NULL, 1);

-- ----------------------------
-- Table structure for tv_production
-- ----------------------------
DROP TABLE IF EXISTS `tv_production`;
CREATE TABLE `tv_production`  (
  `pr_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT,
  `pr_name` text CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `pr_content` text CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `pr_src` text CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `pr_img` text CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `pr_time` date DEFAULT NULL,
  `pr_published` int(11) NOT NULL,
  PRIMARY KEY (`pr_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 3 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Compact;

-- ----------------------------
-- Records of tv_production
-- ----------------------------
INSERT INTO `tv_production` VALUES (1, '边泉博客', '前端：vue+vuex+vue-router+axios<br>\n后台：PHP+MySQL<br>\n兼容性：ie9+，采用响应式布局，支持移动端\n,\n主要功能：用户登录、注册，游客、会员评论回复，<br>\n回复邮件通知，文章管理、图片管理等等。', 'http://www.ynxnw.top/articleList/article/8', '../../static/imgs/20180406/home1.jpg,../../static/imgs/20180406/mobile1.jpg', '2018-04-04', 1);
INSERT INTO `tv_production` VALUES (2, '项目二', '这个是项目二，占坑用的\n,\n其实根本没有项目二这东西。', 'https://www.baidu.com/', '../../static/imgs/20180406/nonew1.jpg,../../static/imgs/20180406/nonew2.jpg', '2018-04-06', 1);

-- ----------------------------
-- Table structure for tv_role
-- ----------------------------
...
CREATE TABLE `tv_role`  (
  ...
  `role_desc` varchar(1000) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '角色描述',
  `create_time` timestamp NULL DEFAULT NULL,
  `update_time` timestamp NULL DEFAULT NULL,
  `delete_time` timestamp NULL DEFAULT NULL,
...
-- Records of tv_role
-- ----------------------------
INSERT INTO `tv_role` VALUES (1, 'admin', '这是超级管理员', NULL, NULL, NULL);
INSERT INTO `tv_role` VALUES (2, 'worker', '这是工作人员', NULL, NULL, NULL);
INSERT INTO `tv_role` VALUES (6, '测试员', '测试用的', NULL, NULL, NULL);

-- ----------------------------
-- Table structure for tv_role_menu
-- ----------------------------
...
-- ----------------------------
-- Records of tv_role_menu
-- ----------------------------
INSERT INTO `tv_role_menu` VALUES (2, 2, 2, NULL, NULL, NULL);
INSERT INTO `tv_role_menu` VALUES (3, 1, 3, NULL, NULL, NULL);
INSERT INTO `tv_role_menu` VALUES (8, 1, 6, NULL, NULL, NULL);
INSERT INTO `tv_role_menu` VALUES (9, 1, 7, NULL, NULL, NULL);
INSERT INTO `tv_role_menu` VALUES (11, 2, 3, NULL, NULL, NULL);
INSERT INTO `tv_role_menu` VALUES (19, 6, 2, NULL, NULL, NULL);
INSERT INTO `tv_role_menu` VALUES (20, 6, 3, NULL, NULL, NULL);
INSERT INTO `tv_role_menu` VALUES (21, 1, 2, NULL, NULL, NULL);
INSERT INTO `tv_role_menu` VALUES (26, 1, 5, NULL, NULL, NULL);
INSERT INTO `tv_role_menu` VALUES (28, 1, 8, NULL, NULL, NULL);

-- ----------------------------
-- Table structure for tv_system_menu
-- ----------------------------
DROP TABLE IF EXISTS `tv_system_menu`;
CREATE TABLE `tv_system_menu`  (
  `menu_id` int(6) NOT NULL AUTO_INCREMENT COMMENT '系统权限菜单表ID',
  `title` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '权限菜单名',
  `father_id` int(6) DEFAULT 0 COMMENT '父级id',
  `create_time` timestamp NULL DEFAULT NULL,
  `update_time` timestamp NULL DEFAULT NULL,
  `delete_time` timestamp NULL DEFAULT NULL,
  `path` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT '/' COMMENT '前端路由路劲',
  `component` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '路由关联组件',
  `icon` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '关联图标',
...
-- ----------------------------
-- Records of tv_system_menu
-- ----------------------------
INSERT INTO `tv_system_menu` VALUES (1, '用户管理', 0, NULL, NULL, NULL, '/user', 'layout/Layout', 'chart', 'userManage', 0);
INSERT INTO `tv_system_menu` VALUES (2, '会员管理', 1, NULL, NULL, NULL, 'user', 'user/user', NULL, 'user', 0);
INSERT INTO `tv_system_menu` VALUES (3, '收货地址', 1, NULL, NULL, NULL, 'address', 'user/address', NULL, 'address', 0);
INSERT INTO `tv_system_menu` VALUES (4, '权限管理', 0, NULL, NULL, NULL, '/auth', 'layout/Layout', 'chart', 'authManage', 0);
INSERT INTO `tv_system_menu` VALUES (5, '管理员', 4, NULL, NULL, NULL, 'admin', 'auth/admin', NULL, 'admin', 0);
INSERT INTO `tv_system_menu` VALUES (6, '角色管理', 4, NULL, NULL, NULL, 'role', 'auth/role', NULL, 'role', 0);
INSERT INTO `tv_system_menu` VALUES (7, '菜单管理', 4, NULL, NULL, NULL, 'menu', 'auth/menu', NULL, 'menu', 0);
INSERT INTO `tv_system_menu` VALUES (8, '接口管理', 4, NULL, NULL, NULL, 'api', 'auth/api', NULL, 'api', 0);
INSERT INTO `tv_system_menu` VALUES (9, '系统管理', 0, NULL, NULL, NULL, '/system', 'layout/Layout', 'chart', 'system', 0);
INSERT INTO `tv_system_menu` VALUES (10, '博客管理', 0, NULL, NULL, NULL, '/blog', 'layout/Layout', 'chart', 'blog', 0);

-- ----------------------------
-- Table structure for tv_tags
-- ----------------------------
DROP TABLE IF EXISTS `tv_tags`;
CREATE TABLE `tv_tags`  (
  `tag_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT,
  `tag_name` text CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `create_time` timestamp NULL DEFAULT NULL,
  `update_time` timestamp NULL DEFAULT NULL,
  `delete_time` timestamp NULL DEFAULT NULL,
...
-- Records of tv_tags
-- ----------------------------
INSERT INTO `tv_tags` VALUES (1, '生活随笔', NULL, NULL, NULL);
INSERT INTO `tv_tags` VALUES (2, '观后感', NULL, NULL, NULL);
INSERT INTO `tv_tags` VALUES (3, '前端', NULL, NULL, NULL);
INSERT INTO `tv_tags` VALUES (4, '后端', NULL, NULL, NULL);
...
CREATE TABLE `tv_user`  (
  ...
  `user_status` varchar(30) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '0' COMMENT '用户状态',
  `user_pwd_salt` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '用户密码盐',
  `introduction` varchar(1000) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '用户简介',
  `update_time` timestamp NULL DEFAULT NULL,
  `create_time` timestamp NULL DEFAULT NULL,
  `delete_time` timestamp NULL DEFAULT NULL,
...
-- Records of tv_user
-- ----------------------------
INSERT INTO `tv_user` VALUES (1, '边泉', 'e7d66c8b123ffad09aa180a9531b6f82', '920200256@qq.com', 'admin', 'eNHm0hMygWF8ggQU0sW6qpusGIo2rxWj', '打发吃的是草', '2018-04-01 00:00:00', NULL, NULL, 2147483647, 1, NULL, 1, 'https://wpimg.wallstcn.com/f778738c-e4f8-4870-b634-56703b4acafe.gif');
INSERT INTO `tv_user` VALUES (2, '测试账号', '41530b8d0e7198a7fa1f3486e488aadb', 'zhonghuatuzi@163.com', 'member', NULL, '打发吃的是草', '2018-04-05 00:00:00', NULL, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `tv_user` VALUES (3, 'dfdf', '45b41a569a52ba13ccfbf182b6e26bd8', '123123@qq.com', 'member', NULL, '', '2018-04-09 00:00:00', NULL, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `tv_user` VALUES (4, '3', '', '21321313333@qq.com', 'visitor', NULL, '', '2018-04-17 00:00:00', NULL, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `tv_user` VALUES (5, '啊', '', '562514042@qq.com', 'visitor', NULL, '', '2018-04-20 00:00:00', NULL, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `tv_user` VALUES (6, '一只吃瓜群众', 'dc5292759dd07023101347119b583707', '960013996@qq.com', 'member', NULL, '', '2018-04-22 00:00:00', NULL, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `tv_user` VALUES (7, 'dfd ', '', '1090099022@qq.com', 'visitor', NULL, '', '2018-04-25 00:00:00', NULL, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `tv_user` VALUES (8, 'dsd', '6e1bbffd02546ea5adeb6c7b93457c01', 'sdsd@qq.com', 'member', NULL, '', '2018-04-27 00:00:00', NULL, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `tv_user` VALUES (9, 'chenyz', '9e5925546b52dd0f67e6700598e5f670', '2115947272@qq.com', 'member', NULL, '', '2018-04-28 00:00:00', NULL, NULL, 1111, NULL, NULL, NULL, NULL);
INSERT INTO `tv_user` VALUES (10, '阿斯蒂芬', '', '1855848448@qq.com', 'visitor', NULL, '', '2018-05-03 00:00:00', NULL, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `tv_user` VALUES (11, 'bog', '', '915156161@qq.com', 'visitor', NULL, '', '2018-05-15 00:00:00', NULL, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `tv_user` VALUES (12, 'th', 'cf890ac6dc2a7eb605d3ad8fdd9c3d84', '915156161@cc.com', 'member', NULL, '', '2018-05-16 00:00:00', NULL, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `tv_user` VALUES (13, 'kk', '54c4e4fd76a8c94f5f8cea3c3c29d71a', '1@kk.com', 'member', NULL, '', '2018-05-16 00:00:00', NULL, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `tv_user` VALUES (14, 'asdfasdf', '', 'asdfasdf@asdf.com', 'visitor', NULL, '', '2018-05-19 00:00:00', NULL, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `tv_user` VALUES (15, '321321', '', '32132@qq.com', 'visitor', NULL, '', '2018-05-19 00:00:00', NULL, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `tv_user` VALUES (16, 'R&Y', 'd5cdbf01ec3357da0dc7416bd31941ac', '550026850@qq.com', 'member', NULL, '', '2018-05-20 00:00:00', NULL, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `tv_user` VALUES (17, '加个微信 我也是泉州的', '', '327083961@qq.com', 'visitor', NULL, '', '2018-05-22 00:00:00', NULL, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `tv_user` VALUES (18, '1212', '', '3123@qqq.com', 'visitor', NULL, '', '2018-05-22 00:00:00', NULL, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `tv_user` VALUES (19, 'ww', '', 'nnnnnn@sdfsf.com', 'visitor', NULL, '', '2018-05-26 00:00:00', NULL, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `tv_user` VALUES (20, '发表评论发表评论发表评论', '', 'nnnnnn@sdfsf.com', 'visitor', NULL, '', '2018-05-26 00:00:00', NULL, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `tv_user` VALUES (21, 'Lx', '', '1063040087@qq.com', 'visitor', NULL, '', '2018-05-28 00:00:00', NULL, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `tv_user` VALUES (22, 'xucanjia', '', '37083961@qq.com', 'visitor', NULL, '', '2018-05-29 00:00:00', NULL, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `tv_user` VALUES (23, '12', 'e4114ec0722e3ecaf7d0b504b606cf88', '123@1123', 'member', NULL, '', '2018-06-03 00:00:00', NULL, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `tv_user` VALUES (24, '123', 'ba1a1a563b7a30a587eaa4ffb026ff6e', '12@1231', 'member', NULL, '', '2018-06-03 00:00:00', NULL, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `tv_user` VALUES (25, '32322', '', '2323232@qq.com', 'visitor', NULL, '', '2018-06-03 00:00:00', NULL, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `tv_user` VALUES (26, 'zh', '', '119@qq.com', 'visitor', NULL, '', '2018-06-15 00:00:00', NULL, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `tv_user` VALUES (27, 'huangjp', '9c6803b4f7b51ff0b8a9f0b9b10465de', '99504022@qq.com', 'member', NULL, '', '2018-06-19 00:00:00', NULL, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `tv_user` VALUES (28, '1111', '5b669a55482998e6ac64135f86892369', '1052650259@qq.com', 'member', NULL, '', '2018-06-20 00:00:00', NULL, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `tv_user` VALUES (29, 'wzn', '911ccdc9fe693dedc2928c54a85da811', '156@163.com', 'member', NULL, '', '2018-06-22 00:00:00', NULL, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `tv_user` VALUES (30, 'ming', '3ef3c37ce39f756a232db8a3ab2674f0', '821170535@qq.com', 'member', NULL, '', '2018-06-26 00:00:00', NULL, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `tv_user` VALUES (31, 'kangcehy', '5d90947459a4493f249655bbde1476c6', 'kangcehy@163.com', 'member', NULL, '', '2018-06-28 00:00:00', NULL, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `tv_user` VALUES (32, '柯佳佳', '', '446457487@qq.com', 'visitor', NULL, '', '2018-06-30 00:00:00', NULL, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `tv_user` VALUES (33, 'salmon', '1d3aca214ecc2f56befe920a674b5096', '844344460@qq.com', 'member', NULL, '', '2018-07-01 00:00:00', NULL, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `tv_user` VALUES (34, '菜鸡', '', '191381577@qq.com', 'visitor', NULL, '', '2018-07-02 00:00:00', NULL, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `tv_user` VALUES (35, 'jief', '', '506907958@qq.com', 'visitor', NULL, '', '2018-07-03 00:00:00', NULL, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `tv_user` VALUES (36, '边泉111', 'b38ed29006731b720b50732a94423ac7', '9202002516@qq.com', '0', 'CDgFwnvzCuoDdr35cd3ESgvy6yYueyBG', '', NULL, NULL, NULL, NULL, 0, NULL, 0, NULL);
INSERT INTO `tv_user` VALUES (37, '边泉1111', '6f47e37ec8c63c49a793f12c73259125', '92020025116@qq.com', '0', 'YKYWYH3OExillINMVc8OHsqFwtf5KHIf', '', NULL, NULL, NULL, NULL, 0, NULL, 0, NULL);
INSERT INTO `tv_user` VALUES (38, '边泉1111对方', 'c79e4cdca5b2704fbcaa9556dbba4269', '9202002511的6@qq.com', '0', 'PmbJUx6zb5GzZt2X8GIt0aRiqT1aKlkj', '', NULL, NULL, NULL, NULL, 0, NULL, 0, NULL);
INSERT INTO `tv_user` VALUES (39, '的道法', 'f1d7150365f0402c783202a716d3f601', '920200@qq.com', '0', 'asT0mREOe7Ah7JLERFOCPmMqQOiLftrR', '', NULL, NULL, NULL, NULL, 0, NULL, 0, NULL);
INSERT INTO `tv_user` VALUES (40, '', '4d87a8155b62270c710dfeed718789f1', '920@qq.com', '0', '5xM6n0dhYtqgdoxgWL6Zv2fGKby10F6g', '', NULL, NULL, NULL, NULL, 0, NULL, 0, NULL);
INSERT INTO `tv_user` VALUES (41, 'dfadsf', 'b46c1e4b6fac23c29723c0937a8e1262', '1234@qq.com', '0', '4XJBVdXEdp8Qt7N9m5xwQQwyf5VcQWGx', '', '2019-02-17 21:04:31', '0000-00-00 00:00:00', NULL, NULL, 0, NULL, 0, NULL);
INSERT INTO `tv_user` VALUES (42, '打发打发', 'e7d66c8b123ffad09aa180a9531b6f82', '92012556@qq.com', '0', 'eNHm0hMygWF8ggQU0sW6qpusGIo2rxWj', '', '2019-02-21 16:44:38', '0000-00-00 00:00:00', NULL, NULL, 0, NULL, 0, NULL);

-- ----------------------------
-- Table structure for tv_web_data
-- ----------------------------
...
-- ----------------------------
-- Records of tv_web_data
-- ----------------------------
INSERT INTO `tv_web_data` VALUES (1, 17, 17, 47, 23190, 0, 0, NULL, NULL, NULL);
