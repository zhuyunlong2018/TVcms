<template>
  <div class="app-container">
    ...
    <el-table v-loading="listLoading" :data="list" size="small" element-loading-text="正在查询中。。。" border fit highlight-current-row>
      ...
      <el-table-column align="center" label="手机号码" prop="user_mobile"/>
      ...
      <el-table-column align="center" label="用户等级" prop="user_level">
        <template slot-scope="scope">
          <el-tag >{{ levelDic[scope.user_level] }}</el-tag>
        </template>
      </el-table-column>
