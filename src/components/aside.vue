      ...
      <div class="msg">
        ...
        <div class="content">
          <ul class="icon" >
            ...
            <li @mouseover="show_text" @click="$router.push('/msgborder')" class="message" ><i class="glyphicon glyphicon-comment" ></i></li>
            <li @mouseover="show_text" @click="_add_praise" class="praise" ><i class="glyphicon glyphicon-thumbs-up" ></i></li>
          </ul>
